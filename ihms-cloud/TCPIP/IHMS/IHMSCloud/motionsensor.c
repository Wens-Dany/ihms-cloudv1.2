...
#define FALL_FLAG FALSE
#define SIT_FLAG FALSE
...
float MaxXmin = 0.7021, MaxXmax = 7.999, MeanXmin = -0.0365, MeanXmax = 0.0370, MaxYmin = 0.2285, MaxYmax = 7.9990, MaxZmin = 0.2471, MaxZmax = 7.9990, MeanYmin = -0.0470, MeanYmax = 0.0192, EnYmin = 16.1496, EnYmax = 1213.7, EnZmin = 1.7870, EnZmax = 797.5010, StdZmin = 0.0423, StdZmax = 0.8933, CovYZmin = -0.6177, CovYZmax = 0.7763;
...
int collect_sensor_data(int f_read)
{
    ...
    float fx, fy, fz;
    float sumX=0, sumY=0, sumZ = 0, sumYZ = 0, meanX=0, meanY=0, meanZ = 0, energySumY=0, maxX = -10000, maxY = -10000, maxZ = -10000, energySumZ = 0, stdZ = 0, covYZ = 0;
    float halfSumX=0, halfSumY=0, halfSumZ = 0, halfSumYZ = 0, halfEnergySumY=0, halfEnergySumZ = 0, halfMaxX = -10000, halfMaxY = -10000, halfMaxZ = -10000;
    BOOL ON = TRUE;
    BOOL  Success = TRUE;
